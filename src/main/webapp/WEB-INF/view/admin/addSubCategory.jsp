				...
				<div class="content-wrapper">
					...
					<div class="row grid-margin">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<f:form Class="cmxform" method="post"
										action="InsertSubCategory" modelAttribute="SubCategoryVO">
										<fieldset>
											<div class="form-group">
												<label for="exampleFormControlSelect1">Category Name</label>
												<f:select path="categoryVO.cid" cssClass="form-control form-control-lg">
														<i:forEach var="i" items="${categoryList}">
															<f:option value="${i.cid}">${i.categoryName}</f:option>
														</i:forEach>
													</f:select>
												<!-- <select class="form-control form-control-lg"
													id="exampleFormControlSelect1">
													<option selected="selected" disabled="disabled">Select Category Name</option>
													<option>Male</option>
											...
											<div class="form-group">
												...
												<f:input path="subCategoryName" cssClass="form-control"
													id="scname" />
											</div>

											<div class="form-group">
												<label for="ccomment">Sub-Category Description</label>
												<f:textarea path="subCategoryDesc" id="sccomment"
