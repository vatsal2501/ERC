...
<%@ taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>					
					<div class="row grid-margin">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<f:form class="cmxform" method="post" action="saveCity"
										modelAttribute="cityVO">
										<fieldset>
											<div class="form-group">
												<label for="cname">State Name</label>
													
												<f:select path="stateVO.stateId" cssClass="form-control" id="stateName">
													
													<c:forEach var="i"  items="${stateVOList}" varStatus="j">	
											...
											<div class="form-group">
												...
												<f:input path="cityName" cssClass="form-control"
													id="cityName" />
											</div>
