			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						<h3 class="page-title">View Sub-category</h3>
											...
											<tbody>
												<c:forEach items="${subCategoryList}" var="i" varStatus="j">
													<tr>
														...
														<td>${i.subCategoryDesc}</td>
														<td><a href="EditSubCategory?id=${i.subCategoryId}"> <i class="mdi mdi-pencil lead"></i>
														</a> <a href="DeleteSubCategory?id=${i.subCategoryId}"> <i
