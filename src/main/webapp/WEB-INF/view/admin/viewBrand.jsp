			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						<h3 class="page-title">View Brand</h3>
								...
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<c:forEach items="${brandList}" var="i" varStatus="j">
													<tr>
														<td>${j.count}</td>
														<td>${i.brandName}</td>
														<td>${i.brandDescription }</td>
														<td><a href="editBrand?id=${i.brandId}"> <i
																class="mdi mdi-pencil lead"></i>
														</a> <a href="deleteBrand?id=${i.brandId}"> <i
