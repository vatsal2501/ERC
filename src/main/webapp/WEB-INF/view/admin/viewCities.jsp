			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						<h3 class="page-title">View City</h3>
								...
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<c:forEach items="${cityVOList}" var="i" varStatus="j">
													<tr>
														<td>${j.count}</td>
														<td>${i.stateVO.stateId}</td>
														<td>${i.cityName}</td>
														<td><a href="editCity?id=${i.cityId}"> <i
																class="mdi mdi-pencil lead"></i>
														</a> <a href="deleteCity?id=${i.cityId}"> <i
