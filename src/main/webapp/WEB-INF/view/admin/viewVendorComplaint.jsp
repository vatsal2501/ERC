								...
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<c:forEach items="${vendorComplaints}" var="i" varStatus="j">
													<tr>
														<td>${j.count }</td>
														...
														<td>
															<c:if test="${i.complaintReply == null}">
																<a href="addVendorComplaintReply?id=${i.complaintId}">
														...
														<td>${i.replyDate }</td>
														<td>
															<div class="modal fade" id="exampleModal-${i.complaintId}"
																tabindex="-1" size="lg" role="dialog"
																aria-labelledby="ModalLabel" aria-hidden="true">
																<div class="modal-dialog" role="document">
																	<div class="modal-content">
																		<div class="modal-header">
																			<h5 class="modal-title" id="ModalLabel">Complaint Details</h5>
															...
															<i class="mdi mdi-information-variant btn"
																type="button"
																data-toggle="modal"
																data-target="#exampleModal-${i.complaintId}"
																data-whatever="@mdo"></i> 
															<!-- <a href="#"> 
																<i class="mdi mdi-delete text-danger lead"></i>
															</a> -->
														</td>
													</tr>
