			...
			<div class="row">
				<div class="col-xl-12 col-lg-12">
					<div class="postCommetnFormBox clearfix">
						<h3 class="commentHeading">How can we help you?</h3>
						<form method="post" action="#" class="commentForm row">


							<div class="col-md-12">
								<textarea name="comContent" placeholder="Describe your issue"></textarea>
							</div>
							<div class="col-md-12">
					...
					<div class="postCommetnListBox clearfix">
						<h3 class="commentHeading">User Comments</h3>
						<ol class="comment-list">
							<li class="clearfix">
								<div class="singleComment">
									...
									<div class="commentContent">i got damage in product.</div>
							...
							<li class="clearfix">
								<div class="singleComment">
									...
									<div class="commentContent">i got product of different color</div>
									<a class="comment-reply" href="javascript:void(0);">Reply</a>
								</div>
							<li class="clearfix">
								<div class="singleComment">
									...
									<div class="commentContent">Poor quality.</div>
									<a class="comment-reply" href="javascript:void(0);">Reply</a>
								</div>
							</li>
