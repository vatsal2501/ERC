						...
						<ol class="comment-list">
							<li class="clearfix">
								<div class="singleComment">
									...
									<div class="commentContent">This product is good enough.</div>
									<div class="#"><i class="mdi mdi-star lead"></i></div>
								</div>
							</li>
							<li class="clearfix">
								<div class="singleComment">
									...
									<div class="commentContent">I found a products which i always wanted.</div>
    ...
    <input type="radio" id="starhalf" name="rating" value="half" /><label class="half" for="starhalf" title="Sucks big time - 0.5 stars"></label></fieldset>
							...
							<li class="clearfix">
								<div class="singleComment">
									...
									<div class="commentContent">Helpful</div>
									<a class="comment-reply" href="javascript:void(0);">Reply</a>
								</div>
							</li>
						</ol>
