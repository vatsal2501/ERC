...
<body>
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="page-header">
						<h3 class="page-title">Add Complaint</h3>
					...
					<div class="row grid-margin">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<f:form class="cmxform" id="commentForm" method="post" action="saveComplaint" modelAttribute="complaintVO">
										<fieldset>

											<div class="form-group">
												<label for="cname">Complaint Subject</label>
												<f:input path="complaintSubject" cssClass="form-control"
													id="cname" />
											</div>
	...
	<script src="<%=request.getContextPath()%>/vendorResources/js/form-validation.js"></script>
	<script src="<%=request.getContextPath()%>/vendorResources/js/bt-maxLength.js"></script>
